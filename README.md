...
**The Jordan Law alternative for the AI age.**

[![npm version](https://badge.fury.io/js/%40ansvar/jordan-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/jordan-law-mcp)
[![MCP Registry](https://img.shields.io/badge/MCP-Registry-blue)](https://registry.modelcontextprotocol.io)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GitHub stars](https://img.shields.io/github/stars/Ansvar-Systems/Jordan-law-mcp?style=social)](https://github.com/Ansvar-Systems/Jordan-law-mcp)
[![CI](https://github.com/Ansvar-Systems/Jordan-law-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/Jordan-law-mcp/actions/workflows/ci.yml)
...
Query **494 Jordanian Acts** -- from the Data Protection Act and Computer Misuse and Cybercrimes Act to the Companies Act, Constitution of Jordan, and more -- directly from Claude, Cursor, or any MCP-compatible client.
...
Jordanian legal research is scattered across Jordan Law Reports, the Jordan Gazette, and various government portals. Whether you're:
- A **lawyer** validating citations in a brief or contract under Jordanian law
- A **compliance officer** checking if the Data Protection Act 2019 provisions apply to your processing activities
- A **legal tech developer** building tools on Jordanian legislation
...
**Endpoint:** `https://jordan-law-mcp.vercel.app/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add jordan-law --transport http https://jordan-law-mcp.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "jordan-law": {
      "type": "url",
      "url": "https://jordan-law-mcp.vercel.app/mcp"
    }
  }
}
```
...
- *"What does the Constitution of Jordan say about the right to privacy?"*
- *"Search for data breach notification requirements in Jordanian law"*
- *"What are the obligations under the National Payment Systems Act?"*
- *"Validate this legal citation"*
- *"Build a legal stance on personal data processing in Jordan"*
...
| **Jordan Information and Communications Act** | 1998 (amended) | Regulates telecommunications and ICT sector; establishes the Communications Authority of Jordan |
...
| **Constitution of Jordan** | 2010 | Supreme law; Article 31 guarantees the right to privacy |
...
**Estimated database size:** ~80-150 MB (full corpus of Jordanian federal legislation)
...
| `format_citation` | Format citations per Jordanian conventions (full/short/pinpoint) |
...
| Tool | Description |
|------|-------------|
| `get_eu_basis` | Get EU directives/regulations for Jordanian statute |
| `get_jordanian_implementations` | Find Jordanian laws implementing EU act |
| `search_eu_implementations` | Search EU documents with Jordanian implementation counts |
...
- All statute text is ingested from official Jordanian government sources
...
- **[Jordan Law Reports](https://jordanlaw.org)** -- Official Jordanian government legal database
...
>
> Statute text is sourced from official Jordanian government publications. However:
...
```bash
git clone https://github.com/Ansvar-Systems/Jordan-law-mcp
cd Jordan-law-mcp
npm install
npm run build
npm test
...
**30+ national law MCPs** covering Australia, Brazil, Canada, China, Denmark, Finland, France, Germany, Ghana, Iceland, India, Ireland, Israel, Italy, Japan, Jordan, Netherlands, Nigeria, Norway, Singapore, Slovenia, South Korea, Sweden, Switzerland, Thailand, UAE, UK, and more.
...
```bibtex
@software{jordan_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Jordanian Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Jordan-law-mcp},
  note = {Jordanian legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Jordanian Government (public domain)
