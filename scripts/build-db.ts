#!/usr/bin/env tsx
/**
 * Database builder for Jordan Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Jordan Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Jordanian statute text',
              );
